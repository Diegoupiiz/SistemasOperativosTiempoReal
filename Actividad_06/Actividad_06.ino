...
void blinkLED(void *parameters) {
  ...
  // Liberamos semaforo binario * Hasta este punto empieza
...
// El semaphore da una configuración
/* El código hace que se encienda y apague el led durante los ms establecido.
   Se manda por UART el retardo que se quería. */
