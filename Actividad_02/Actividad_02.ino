...
/* ----------------------Comentario---------------------------
   La tarea de alta prioridad solo se ejecuta una vez. Cuando se
   probó el código se imprimían asteriscos, esto pasa cuando la
   tarea de baja prioridad se elimina. Aunque se suspenda la de
   alta prioridad, se siguen imprimiendo los asteriscos.
   */
